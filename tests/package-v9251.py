...
beta = stable.with_name('LunaxyMusic-V92.5.1-Beta')
delivery = stable.parent / 'deliverables/LunaxyMusic-V92.5.1'
...
if '--prepare' in sys.argv:
    ...
    text = p.read_text(encoding='utf-8').replace('applicationId = "com.xingyu.music"', 'applicationId = "com.xingyu.music.beta1"').replace('versionCode = 932', 'versionCode = 933').replace('versionName = "92.5.1"', 'versionName = "92.5.1-beta31"').replace('Stable-92.5.1', 'Beta-92.5.1-beta31')
    ...
    for root, version, channel in [(stable, '92.5.1', 'Stable'), (beta, '92.5.1-beta31', 'Beta')]:
