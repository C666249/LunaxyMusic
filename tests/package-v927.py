...
beta = stable.with_name('LunaxyMusic-V92.7-Beta')
delivery = stable.parent / 'deliverables/LunaxyMusic-V92.7'
...
if '--prepare' in sys.argv:
    ...
    text = p.read_text(encoding='utf-8').replace('applicationId = "com.xingyu.music"', 'applicationId = "com.xingyu.music.beta1"').replace('versionCode = 936', 'versionCode = 937').replace('versionName = "92.7.0"', 'versionName = "92.7.0-beta33"').replace('Stable-92.7.0', 'Beta-92.7.0-beta33')
    ...
    for root, version, channel in [(stable, '92.7.0', 'Stable'), (beta, '92.7.0-beta33', 'Beta')]:
